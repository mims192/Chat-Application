...
const Sidebar = ({ onSelectUser }) => {
    ...
    return (
        <div className='h-full w-auto px-1 bg-green-50'>
            <div className='flex justify-between gap-2'>
                <form onSubmit={handelSearchSubmit} className='w-auto flex items-center justify-between my-2 bg-white rounded-full '>
                    <input
                        value={searchInput}
                                    ...
                                    <div
                                        ...
                                        <div className={`avatar ${isOnline[index] ? 'online':''}`}>
                                            <div className="w-12 rounded-full">
                                                <img src={user.profilpic} alt='user.img' />
                                            </div>
                                        </div>
