...
const MessageContainer = ({ onBackUser }) => {
    ...
    return (
        <div className='md:min-w-[500px] h-[99%] flex flex-col py-2 bg-green-100'>
              ...
              <div className='flex gap-2 md:justify-between items-center w-full'>
                ...
                <div className='flex justify-between mr-2 gap-2'>
                  <div className='self-center'>
                    <img className='rounded-full w-6 h-6 md:w-10 md:h-10 cursor-pointer' src={selectedConversation?.profilpic} />
                  </div>
